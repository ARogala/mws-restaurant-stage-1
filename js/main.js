...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1Ijoid2ViZGV2ODMiLCJhIjoiY2pqb2RlZ2g2N2xqaTNrcDFpcThkb2I2MCJ9.7SL2g6_M2SpvUCYDiFHJkw',
    maxZoom: 18,
...
createRestaurantHTML = (restaurant) => {
  ...
  more.setAttribute('aria-label', 'Read review for '  + restaurant.name + ' address ' + restaurant.address);
  li.append(more)
